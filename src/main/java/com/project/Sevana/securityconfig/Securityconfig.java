...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity//this is to enable @PreAuthorize annotation so you can lock specific requests from specific users
public class Securityconfig {
	...
	public SecurityFilterChain securityfilterchain(HttpSecurity http) throws Exception{
		...
		http.authorizeHttpRequests(requests->requests.requestMatchers("/register/**","/login/**","/not-found","/api/locations/**","/auth/**","/health").
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		confi.setAllowedOrigins(List.of("http://localhost:5173","https://srp-frontend-pearl.vercel.app"));
